...
| Resource | Rohmaterial wird Resource oder Resource-Link. | Raw Capture -> Resource Draft -> Resource erstellen -> Resources | Resource Draft ist minimal verbunden: Titel, Typ, Kurzfassung/Inhalt, optionale URL. Das Inbox Item wird danach ohne Hard Delete archiviert. | Keine Resource-Graph-Kanten automatisch erzeugen. |
