  ...
  return (
    ...
    >
      <header className="overflow-hidden rounded-[18px] border border-[var(--border-subtle)] bg-[rgba(15,23,36,.72)] shadow-[0_8px_22px_rgba(0,0,0,.12)]">
        <div className="grid gap-3 bg-[linear-gradient(90deg,rgba(91,124,250,.055),rgba(217,146,79,.045)_44%,transparent_72%)] px-4 py-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
          <div>
      ...
      <div className="grid gap-2 xl:grid-cols-12">
        <SkeletonPanel className="xl:col-span-7" rows={6} />
        <SkeletonPanel className="xl:col-span-5" rows={5} />
        <SkeletonPanel className="xl:col-span-7" rows={6} />
        <SkeletonPanel className="xl:col-span-5" rows={6} />
