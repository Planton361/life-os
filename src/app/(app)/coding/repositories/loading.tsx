...
export default function CodingRepositoriesLoading() {
  return (
    <div
      aria-busy="true"
    ...
    >
      ...
      <section className="rounded-[18px] border border-[var(--border-subtle)] bg-[rgba(15,23,36,.74)] p-4">
        <div className="grid gap-3 xl:grid-cols-[minmax(220px,1.2fr)_repeat(4,minmax(150px,.8fr))]">
          <SkeletonLine className="h-11 rounded-[12px]" />
          <SkeletonLine className="h-11 rounded-[12px]" />
          <SkeletonLine className="h-11 rounded-[12px]" />
          <SkeletonLine className="h-11 rounded-[12px]" />
          <SkeletonLine className="h-11 rounded-[12px]" />
      ...
      <div className="grid gap-2 xl:grid-cols-12">
        ...
        <SkeletonPanel className="xl:col-span-8" rows={6} />
        <SkeletonPanel className="xl:col-span-4" rows={4} />
        <SkeletonPanel className="xl:col-span-4" rows={4} />
