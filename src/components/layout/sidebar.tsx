...
export function Sidebar() {
  return (
    <aside className="border-b border-[var(--border-default)] bg-[var(--bg-app)] p-3 lg:min-h-dvh lg:border-b-0 lg:border-r">
      <div className="rounded-[24px] border border-[var(--border-subtle)] bg-[#070b13] px-4 py-5 shadow-[0_8px_22px_rgba(0,0,0,0.12)] lg:min-h-[calc(100dvh-24px)]">
        ...
        <div
          ...
          className="mt-5 flex min-h-[42px] items-center justify-between rounded-[13px] border border-[rgba(168,183,204,.16)] bg-[#0c1422] px-4 text-[11px] font-medium text-[var(--text-secondary)]"
          role="search"
        >
        ...
        <nav aria-label="Hauptnavigation" className="mt-5 space-y-5">
