...
export function StrengthHeader({
  ...
  return (
    <header className="min-w-0 overflow-hidden rounded-[18px] border border-[rgba(217,146,79,.16)] bg-[rgba(15,23,36,.82)] shadow-[0_8px_22px_rgba(0,0,0,.12)] xl:rounded-[16px]">
